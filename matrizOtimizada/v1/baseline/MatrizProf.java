...
class MatrizProf {
    ...
    MatrizProf(int numLinhas, int numColunas) {
    ...
    private int detOrdem1(MatrizProf mat) {
        return mat.getValor(0, 0);
    }

    private int detOrdem2(MatrizProf mat) {
    ...
    public void copiaMatrizMaiorParaMenor(MatrizProf maior, MatrizProf menor, int isqn, int jsqn) {
    ...
    private int detOrdemN(MatrizProf mat) {
        ...
        for (contC = 0; contC < mat.getTamanhoColuna(); contC++) {
            ...
            matmenor = new MatrizProf(numL - 1, numC - 1);
